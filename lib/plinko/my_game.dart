...
import 'package:xgamblur/plinko/modal/plinko_result_model.dart';
                ...
                actions: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Image.asset("assets/andarbahar/bethistory.png"),
                    ),
                  ),
                  const SizedBox(
                    width: 10,
...
print("bhagona");
  ...
  Future<void> fetchPlinkoBethistoryTwo() async {
    ...
    print(Uri.parse("${ApiUrl.plinkoBetHistory}$userId&limit=15"));
    print("KKKKLLLLL");
    setState(() {
      responseStatuscode = response.statusCode;
    });
