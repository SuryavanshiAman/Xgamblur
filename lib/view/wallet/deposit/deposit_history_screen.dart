...
import 'package:xgamblur/view_model/deposit_history_view_model.dart';
...
@override
  void initState() {
    ...
    super.initState();
    Provider.of<DepositHistoryViewModel>(context,listen: false).depositHistoryApi("0", "", "", context);
  }
  @override
        ...
        children: [
          Container(
            ...
            child: ListView.builder(
                ...
                itemCount: deposit.paymentHistoryOptions.length,
                scrollDirection: Axis.horizontal,
                itemBuilder: (context, index) {
                  final items=deposit.paymentHistoryOptions[index];
                  return GestureDetector(
                    onTap: () {
                      ...
                      scrollToIndex(index);
                      depositHistory.depositHistoryApi(selectedCatIndex, "", "", context);
                    },
                    child: Container(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          buildRow("Type","${data.type}".tr, Colors.white),
