...
import 'package:xgamblur/view_model/deposit_view_model.dart';
...
class _DepositScreenState extends State<DepositScreen> {
  ...
  void _handleListItemSelected(int index) {
    print(index);
    setState(() {
      _selectedItemIndex = type == 1 ? usdAmount[index] : indianAmount[index];
      amountCont.text = type == 1 ? usdAmount[index].toString() : indianAmount[index].toString(); // Update TextFormField text
      _usdtController.text = type == 1 ? usdAmount[index].toString() : indianAmount[index].toString(); // Update TextFormField text
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: GradientAppBar(
        ...
        title: Text(
          "Deposit".tr,
          style: const TextStyle(color: AppColor.white, fontFamily: "SitkaSmall"),
        ),
        actions: [
          InkWell(
            onTap: (){
                ...
                GridView.builder(
                    ...
                    gridDelegate:
                        const SliverGridDelegateWithMaxCrossAxisExtent(
                            ...
                            mainAxisSpacing: 10),
                    itemCount:
                        type == 1 ? usdAmount.length : indianAmount.length,
...
readOnly: true,
                  ...
                  borderRadius: BorderRadius.circular(15),
                  fieldRadius: BorderRadius.circular(15),
                  prefix: const Icon(Icons.currency_rupee, color: AppColor.white),
                ...
                constantbutton(
                    width: width * 0.8, onTap: () {
                      if (_usdtController.text.isEmpty){
                        ...
                        selectedIndex==1?Navigator.pushNamed(context, RoutesName.usdtDepositScreen,arguments: {
                          "amount":_convertedController.text,
                          "usdt":_usdtController.text
                        }):deposit.depositApi(amountCont.text, context);
                      }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    const Icon(IconlyBroken.info_circle, color: AppColor.white),
