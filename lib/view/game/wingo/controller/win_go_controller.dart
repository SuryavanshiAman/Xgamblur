...
import '../view_model/win_go_my_his_view_model.dart';
import '../view_model/win_go_result_view_model.dart';
...
class WinGoController with ChangeNotifier {
  ...
  void calculateAmount() {
    ...
    amount.text = (balanceValue * multiplierValue).toString();
  }
  ...
  void connectToServer(context) {
    ...
    _socket.on(ApiUrl.wingoEventTen, (response) {
    ...
    _socket.on(ApiUrl.wingoEventOne, (response) {
      final res = jsonDecode(response);
    ...
    _socket.on(ApiUrl.wingoEventThree, (response) {
      final res = jsonDecode(response);
    ...
    _socket.on(ApiUrl.wingoEventFive, (response) {
      final res = jsonDecode(response);
