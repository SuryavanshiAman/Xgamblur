    ...
    return Consumer<WinGoController>(builder: (context, wgc, child) {
      ...
      return Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
              image: AssetImage(Assets.winGoBgCutRed,), fit: BoxFit.fill,colorFilter: ColorFilter.mode(
            AppColor.gray, // Apply the color here
            BlendMode.srcIn,
          )),
        ),
        child: Row(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                textWidget(
                  text: wingoResult.gameSrNo != null ? wingoResult.gameSrNo.toString() : '',
                  color: AppColor.white,
                  fontSize: 14,
                ),
              ],
